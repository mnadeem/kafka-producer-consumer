package com.mnadeem.example.kafka.admin;
...
public final class Admin {
	...
	public static void describeTopics(String brokers, String topicName) {
	...
	public static void deleteTopics(String brokers, String topicName) {
		// Set properties used to configure admin client
		Properties properties = getProperties(brokers);
	...
	public static void createTopics(String brokers, String topicName) {
		// Set properties used to configure admin client
		Properties properties = getProperties(brokers);
